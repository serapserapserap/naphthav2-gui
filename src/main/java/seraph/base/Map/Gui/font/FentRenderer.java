...
public class FentRenderer extends FontCore implements Comparator<String> {
    ...
    public FentRenderer(Font font, boolean antiAlias, boolean fractionalMetrics) {
    ...
    public int drawStringWithShadow(String text, double x2, float y2, int color, float scale) {

        float shadowWidth = this.drawString(text, x2 + 0.9f, (double) y2 + 0.5f, color, true, 8.3f, scale);

        return (int) Math.max(shadowWidth, this.drawString(text, x2, y2, color, false, 8.3f, scale));
    }
    ...
    public int drawString(String text, double x2, float y2, int color, float scale) {
        return (int) this.drawString(text, x2, y2, color, false, 8.3f, scale);
    }
    ...
    public float drawCenteredString(String text, float x2, float y2, int color, float scale) {
        return this.drawString(text, x2 - (float) (this.getScaledStringWidth(text,scale) / 2), y2, color, false, 8.3f, scale);
    }
    ...
    public float drawCenteredStringWithShadow(String text, float x2, float y2, int color, float scale) {
        return this.drawStringWithShadow(text, x2 - (float) (this.getScaledStringWidth(text,scale) / 2), y2, color, scale);
    }

    public float drawString(String text, double x, double y, int color, boolean shadow, float kerning) {
        return this.drawString(text, x, y, color, shadow, kerning, 1.f);
    }

    public float drawString(String text, double x, double y, int color, boolean shadow, float kerning, float scale) {
        x -= 1.0;
        ...
        for (int index = 0; index < text.length(); index++) {
            ...
            if (character == '\u00a7') {
                ...
                try {
                    colorIndex = "0123456789abcdefklmnorz".indexOf(text.charAt(index + 1));
                    GL20.glUseProgram(0);
                    //print("0123456789abcdefklmnorz".indexOf("z") + "");
                } catch (Exception e) {
                    e.printStackTrace();
                }
                ...
                if (colorIndex < 16) {
                    ...
                    int colorcode = resetColour ? color : this.colorCode[colorIndex];
    ...
    public float drawSmoothString(String text, double x, double y, int color, boolean shadow) {
        return this.drawSmoothString(text,x,y,color,shadow,1.f);
    }

    public float drawSmoothString(String text, double x, double y, int color, boolean shadow, float scale) {
        x -= 1;
    ...
    public float drawNoBSString(String text, double x, double y, int color, boolean shadow) {
        return this.drawNoBSString(text,x,y,color,shadow,1.f);
    }

    public float drawNoBSString(String text, double x, double y, int color, boolean shadow, float scale) {
        x -= 1;
    ...
    public double getScaledStringWidth(String text, float scale) {
        return this.getStringWidth(text) * scale;
    }

    public double getScaledStringHeight(float scale) {
